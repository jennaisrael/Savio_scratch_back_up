    ...
    class Result:
        ...
        def set_domain(self, domain, ax):
            ...
            if domain == "SSC":
                ...
                #add the locations of the tunnel intakes as stars
                ax.scatter([629190.1, 628147.3],[4249156.2, 4245629.2], marker='*',color='r')
                #stations 3&10 based on the sinks I added
                #ax.scatter([629238.136,628119.263],[4249308.963,4245754.202],marker='^',color='r')
                ax.set_xlim(624275, 633530) 
                ax.set_ylim(4243920, 4251826)
            elif domain=="North_Delta":
                #add the locations of the tunnel intakes as stars
                ax.scatter([629190.1, 628147.3],[4249156.2, 4245629.2], marker='*',color='r')
                #stations 3&10 based on the sinks I added
                #ax.scatter([629238.136,628119.263],[4249308.963,4245754.202],marker='^',color='r')
                ax.set_xlim(624175, 633630) 
                ax.set_ylim(4240020, 4251926)
        ...
        def plot_variable(self, schism_output, domain="SSC", time="average",
            ...
            # added to deal with newer version of numpy/ matplotlib incompatibility
            tri_coords = np.asarray(tri_coords, dtype=np.float64)
            tri_colors = np.asarray(tri_colors, dtype=np.float64)

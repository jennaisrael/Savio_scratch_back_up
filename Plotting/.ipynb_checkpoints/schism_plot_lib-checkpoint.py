...
class SchismOutput():
    ...
    def read_grid(self):
        ...
        grid_fn = self.run_dir / "hgrid.gr3"
    ...
    class Result:
        ...
        def plot_variable(self, schism_output, domain="SSC", time="average", depth="average"):
            '''
            ...
            quad_value = np.mean(values[schism_output.hgrid.quads], axis=0)

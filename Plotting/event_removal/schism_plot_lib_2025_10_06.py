...
climits['salinity'] = [-0.1,0.1]#[-1,1]#[-1.5,0] #[0, 35]
...
# Basemap 
basemap = '//home/jisrael/Savio_scratch_back_up/Plotting/basemap_delta.tif' #'/global/home/groups/fc_esdl/data/plotting/basemap_delta.tif'
...
class SchismOutput():
    ...
    class Result:
        ...
        def plot_variable(self, schism_output, domain="SSC", time="average", depth="average",titlestr="string"):
            ...
            cmap = cmocean.cm.deep #balance #algae #ice #ccm.imola_r # cmocean.haline #
            ##For dry flag
            ...
            cbar = plt.colorbar(pc, orientation="vertical", shrink=0.6)
            #for the change in salinity plotting JI 07/30
            #cbar.set_label('Scenario Salinity- Historical Salinity [PSU]')
            cbar.set_label('Event Removed - Historical Salinity [PSU]')

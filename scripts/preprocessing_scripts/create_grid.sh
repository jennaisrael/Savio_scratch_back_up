...
# Go to folder 
cd /global/scratch/users/jennaisrael/BayDeltaSCHISM/templates/bay_delta_JI

# takes about 20-30 min 

prepare=/global/home/users/jennaisrael/.conda/envs/schism/lib/python3.10/site-packages/schimpy/prepare_schism.py


# Run the prepare_schism.py script 
conda run -n schism python $prepare main_bay_delta_JI.yaml
